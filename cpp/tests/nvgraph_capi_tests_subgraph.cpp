...
namespace
{
	...
	{
	public:
		file_read_error(const std::string &msg) : msg_(msg)
		{
...
{
public:
	NvgraphCAPITests_SubgraphCSR() : nvgraph_handle(NULL), initial_graph(NULL)
	{
	}
...
{
public:
	NvgraphCAPITests_SubgCSR_Isolated() : nvgraph_handle(NULL), initial_graph(NULL)
	{
	}
