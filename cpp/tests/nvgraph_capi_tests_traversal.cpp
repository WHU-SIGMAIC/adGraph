...
INSTANTIATE_TEST_CASE_P(CorrectnessCheck,
                        ...
                        ::testing::Values(
                            ...
                            ,
                            Traversal_Usecase("dimacs10/road_usa_T.mtx.bin", 100), Traversal_Usecase("graphs/Twitter/twitter.bin", 0), Traversal_Usecase("graphs/Twitter/twitter.bin", 100), Traversal_Usecase("graphs/Twitter/twitter.bin", 10000), Traversal_Usecase("graphs/Twitter/twitter.bin", 3000000)
                            //, Traversal_Usecase("dimacs10/hugebubbles-00020_T.mtx.bin", 100000)
                            ///// instances using mask
                            ,
                            Traversal_Usecase("graphs/small/small.bin", 0, true), Traversal_Usecase("graphs/small/small.bin", 0, true), Traversal_Usecase("graphs/small/small.bin", 3, true), Traversal_Usecase("graphs/dblp/dblp.bin", 0, true), Traversal_Usecase("graphs/dblp/dblp.bin", 100, true), Traversal_Usecase("graphs/dblp/dblp.bin", 1000, true), Traversal_Usecase("graphs/dblp/dblp.bin", 100000, true), Traversal_Usecase("graphs/Wikipedia/2003/wiki2003.bin", 0, true))
