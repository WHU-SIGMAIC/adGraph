...
typedef struct SSSP_Usecase_t
{
    ...
    double tolerance_mul;
    SSSP_Usecase_t(const std::string &a, int b, const std::string &c, double tolerance_multiplier = 1.0) : source_vert(b), tolerance_mul(tolerance_multiplier)
    {
        graph_file = convert_to_local_path(a);
        result_file = convert_to_local_path_refdata(c);
    };
...
typedef struct WidestPath_Usecase_t
{
    ...
    std::string result_file;
    double tolerance_mul;
    WidestPath_Usecase_t(const std::string &a, int b, const std::string &c, double tolerance_multiplier = 1.0) : source_vert(b), tolerance_mul(tolerance_multiplier)
    {
        graph_file = convert_to_local_path(a);
        result_file = convert_to_local_path_refdata(c);
    };
...
typedef struct Pagerank_Usecase_t
{
    ...
    std::string result_file;
    double tolerance_mul;
    Pagerank_Usecase_t(const std::string &a, float b, const std::string &c, double tolerance_multiplier = 1.0) : alpha(b), tolerance_mul(tolerance_multiplier)
    {
        graph_file = convert_to_local_path(a);
        result_file = convert_to_local_path_refdata(c);
    };
...
public:
    ...
    void run_current_test(const SrSPMV_Usecase &param)
    {
        ...
        if (print_test_timings)
            printf("Test took: %f seconds from which %f seconds were spent on data reading\n", test_end - test_start, read_end - read_start);
    }
};
...
INSTANTIATE_TEST_CASE_P(CorrectnessCheck,
                        ...
                        ::testing::Values(
                            WidestPath_Usecase("graphs/cage/cage13_T.mtx.bin", 0, "graphs/cage/cage13.widest_0.bin"), WidestPath_Usecase("graphs/cage/cage13_T.mtx.bin", 101, "graphs/cage/cage13.widest_101.bin"), WidestPath_Usecase("graphs/cage/cage14_T.mtx.bin", 0, "graphs/cage/cage14.widest_0.bin"), WidestPath_Usecase("graphs/cage/cage14_T.mtx.bin", 101, "graphs/cage/cage14.widest_101.bin")
                            // file might be missing on eris
                            //, WidestPath_Usecase("graphs/small/small_T.bin", 2,  "graphs/small/small_T.widest_2.bin")
                            ,
                            WidestPath_Usecase("graphs/dblp/dblp.bin", 100, "graphs/dblp/dblp_T.widest_100.bin"), WidestPath_Usecase("graphs/dblp/dblp.bin", 100000, "graphs/dblp/dblp_T.widest_100000.bin"), WidestPath_Usecase("graphs/Wikipedia/2003/wiki2003_T.bin", 100, "graphs/Wikipedia/2003/wiki2003_T.widest_100.bin"), WidestPath_Usecase("graphs/Wikipedia/2003/wiki2003_T.bin", 100000, "graphs/Wikipedia/2003/wiki2003_T.widest_100000.bin"), WidestPath_Usecase("graphs/citPatents/cit-Patents_T.mtx.bin", 6543, "")
...
INSTANTIATE_TEST_CASE_P(CorrectnessCheck,
                        ...
                        //                                            // we read matrix stored in CSR and pass it as CSC - so matrix is in fact transposed, that's why we compare it to the results calculated on a transposed matrix
                        ::testing::Values(
                            SSSP_Usecase("graphs/cage/cage13_T.mtx.bin", 0, "graphs/cage/cage13.sssp_0.bin"), SSSP_Usecase("graphs/cage/cage13_T.mtx.bin", 101, "graphs/cage/cage13.sssp_101.bin"), SSSP_Usecase("graphs/cage/cage14_T.mtx.bin", 0, "graphs/cage/cage14.sssp_0.bin"), SSSP_Usecase("graphs/cage/cage14_T.mtx.bin", 101, "graphs/cage/cage14.sssp_101.bin"), SSSP_Usecase("graphs/small/small.bin", 2, "graphs/small/small.sssp_2.bin"), SSSP_Usecase("graphs/dblp/dblp.bin", 100, "graphs/dblp/dblp_T.sssp_100.bin"), SSSP_Usecase("graphs/dblp/dblp.bin", 100000, "graphs/dblp/dblp_T.sssp_100000.bin"), SSSP_Usecase("graphs/Wikipedia/2003/wiki2003.bin", 100, "graphs/Wikipedia/2003/wiki2003_T.sssp_100.bin"), SSSP_Usecase("graphs/Wikipedia/2003/wiki2003.bin", 100000, "graphs/Wikipedia/2003/wiki2003_T.sssp_100000.bin"), SSSP_Usecase("graphs/citPatents/cit-Patents_T.mtx.bin", 6543, "")
