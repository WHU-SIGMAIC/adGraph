...
/**
 * Call `hipDeviceSynchronize()` using the proper API for the current CUB and
 * CUDA configuration.
 */
CUB_EXEC_CHECK_DISABLE
CUB_RUNTIME_FUNCTION inline hipError_t device_synchronize()
{
...
#else // CUDA < 11.6:
#define CUB_TMP_DEVICE_SYNC_IMPL result = hipDeviceSynchronize();
#endif
