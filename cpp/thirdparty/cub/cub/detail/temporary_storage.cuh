 ...
 * @par A Simple Example
 * @code
 * hipcub::detail::temporary_storage::layout<3> temporary_storage;
 *
...
public:
  ...
  __host__ __device__ std::size_t get_size()
  {
    ...
    if (temp_storage_bytes == 0)
    {
      ...
      // `hipMalloc` will return `nullptr`. This fact makes it impossible to
   ...
   */
  __host__ __device__ hipError_t map_to_buffer(void *d_temp_storage,
                                                std::size_t temp_storage_bytes)
  {
