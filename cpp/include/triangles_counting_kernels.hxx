...
template <typename T>
void tricnt_wrp(T nblock, spmat_t<T> *m, uint64_t *ocnt_d, unsigned int *bmap_d, size_t bmld, ihipStream_t* stream);
template <typename T>
void tricnt_thr(T nblock, spmat_t<T> *m, uint64_t *ocnt_d, ihipStream_t* stream);
template <typename T>
void tricnt_b2b(T nblock, spmat_t<T> *m, uint64_t *ocnt_d, unsigned int *bmapL0_d, size_t bmldL0, unsigned int *bmapL1_d, size_t bmldL1, ihipStream_t* stream);
...
void myCudaMemset(unsigned long long *p, unsigned long long v, long long n, ihipStream_t* stream);
