                               ...
                               const bool weighted)
{
  ...
  T m2 = thrust::reduce(thrust::hip::par, csr_val_d.begin(), csr_val_d.end());
                                     ...
                                     const bool weighted)
{
  ...
  T m2 = thrust::reduce(thrust::hip::par, csr_val_d.begin(), csr_val_d.end() + n_edges);
  ...
  hr_clock.stop(&timed);
  double mod_time(timed);
  double Q = thrust::reduce(thrust::hip::par, Q_arr_ptr, Q_arr_ptr + size, (0.0));
