...
namespace nvlouvain
{
  ...
  public:
    ...
    {
      thrust::fill(thrust::hip::par, this->begin(), this->end(), val);
    }
  ...
  public:
    CsrGraph(thrust::device_vector<IndexType> &csr_ptr_d, thrust::device_vector<IndexType> &csr_ind_d, thrust::device_vector<ValueType> &csr_val_d, IndexType v, IndexType e, bool _w = false) : _n_vertices(v), _n_edges(e), csr_ptr(csr_ptr_d.begin(), csr_ptr_d.end()), csr_ind(csr_ind_d.begin(), csr_ind_d.end()), csr_val(csr_val_d.begin(), csr_val_d.end()), weighted(_w)
    {
    }

    CsrGraph(thrust::host_vector<IndexType> &csr_ptr_d, thrust::host_vector<IndexType> &csr_ind_d, thrust::host_vector<ValueType> &csr_val_d, IndexType v, IndexType e, bool _w = false) : _n_vertices(v), _n_edges(e), csr_ptr(csr_ptr_d.begin(), csr_ptr_d.end()), csr_ind(csr_ind_d.begin(), csr_ind_d.end()), csr_val(csr_val_d.begin(), csr_val_d.end()), weighted(_w)
    {
    }
