    ...
    namespace cuda
    {
      namespace detail
      {
        ...
        public:
          ...
          __host__ __device__ inline cublas::execute_with_cublas with(const hipblasHandle_t &handle) const
          {
...
#if THRUST_VERSION >= 100900
            thrust::hip_rocprim::cross_system<System1, System2>
#else
        ...
        {
#if THRUST_VERSION >= 100900
          using namespace thrust::hip_rocprim;
#else
