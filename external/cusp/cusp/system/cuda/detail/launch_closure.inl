    ...
    namespace system
    {
        namespace cuda
        {
            namespace detail
            {
                ...
                __global__ __launch_bounds__(Closure::context_type::ThreadsPerBlock::value, Closure::context_type::BlocksPerMultiprocessor::value) void launch_closure_by_value(Closure f)
                {
                    f();
                }

                template <typename Closure>
                __global__ __launch_bounds__(Closure::context_type::ThreadsPerBlock::value, Closure::context_type::BlocksPerMultiprocessor::value) void launch_closure_by_pointer(const Closure *f)
                {
                    // copy to registers
                    Closure f_reg = *f;
                    f_reg();
                ...
                struct closure_launcher_base<Closure, false>
                {
                    ...
                    static void launch(Closure f, Size1 num_blocks, Size2 block_size, Size3 smem_size)
                    {
                        ...
                        if (num_blocks > 0)
                        {
                            ...
                            thrust::detail::temporary_array<Closure, thrust::hip::tag> closure_storage(cuda_tag, host_tag, &f, &f + 1);
