              ...
              cusp::array1d_format)
{
    ...
    if(HIPSPARSE_STATUS_SUCCESS != hipsparseCreate(&cusparse)) {
    ...
    if(HIPSPARSE_STATUS_SUCCESS != hipsparseScsrmv(cusparse,
            HIPSPARSE_OPERATION_NON_TRANSPOSE, A.num_rows, A.num_cols, A.num_entries, &alpha,
