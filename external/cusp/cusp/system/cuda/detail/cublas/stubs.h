...
#define CUSP_CUBLAS_EXPAND_DEFS_LOWER(FUNC_MACRO)               \
  FUNC_MACRO(float , float , s)                                 \
  FUNC_MACRO(double, double, d)                                 \
  FUNC_MACRO(cusp::complex<float> , hipComplex,  c)              \
  FUNC_MACRO(cusp::complex<double>, hipDoubleComplex, z)
...
#define CUSP_CUBLAS_EXPAND_COMPLEX_DEFS_2(FUNC_MACRO)           \
  FUNC_MACRO(cusp::complex<float> , hipComplex,  Sc)             \
  FUNC_MACRO(cusp::complex<double>, hipDoubleComplex, Dz)
...
#define CUSP_CUBLAS_ASUM(T,V,name)                                                            \
  template<int dummy>                                                                         \
  hipblasStatus_t asum( hipblasHandle_t handle,                                                 \
...
#define CUSP_CUBLAS_AXPY(T,V,name)                                                            \
  template<int dummy>                                                                         \
  hipblasStatus_t axpy( hipblasHandle_t handle,                                                 \
...
#define CUSP_CUBLAS_COPY(T,V,name)                                                            \
  template<int dummy>                                                                         \
  hipblasStatus_t copy( hipblasHandle_t handle,                                                 \
...
#define CUSP_CUBLAS_DOT(T,V,name)                                                             \
  template<int dummy>                                                                         \
  hipblasStatus_t dot( hipblasHandle_t handle,                                                  \
...
#define CUSP_CUBLAS_DOTC(T,V,name)                                                            \
  template<int dummy>                                                                         \
  hipblasStatus_t dotc( hipblasHandle_t handle,                                                 \
...
#define CUSP_CUBLAS_DOTU(T,V,name)                                                            \
  template<int dummy>                                                                         \
  hipblasStatus_t dotu( hipblasHandle_t handle,                                                 \
                       const int n, const T* X, const int incX, const T* Y,                   \
                       const int incY, T& ret )                                               \
  {                                                                                           \
...
#define CUSP_CUBLAS_NRM2(T,V,name)                                                            \
  template<int dummy>                                                                         \
  hipblasStatus_t nrm2( hipblasHandle_t handle,                                                 \
                       const int n, const T* X, const int incX,                               \
                       typename cusp::norm_type<T>::type& result)                             \
  {                                                                                           \
...
#define CUSP_CUBLAS_SCAL(T,V,name)                                                            \
  template<int dummy>                                                                         \
  hipblasStatus_t scal( hipblasHandle_t handle,                                                 \
...
#define CUSP_CUBLAS_SWAP(T,V,name)                                                            \
  template<int dummy>                                                                         \
  hipblasStatus_t swap( hipblasHandle_t handle,                                                 \
...
#define CUSP_CUBLAS_GEMV(T,V,name)                                                            \
  template<int dummy>                                                                         \
  hipblasStatus_t gemv( hipblasHandle_t handle,                                                 \
...
#define CUSP_CUBLAS_SYMV(T,V,name)                                                            \
  template<int dummy>                                                                         \
  hipblasStatus_t symv( hipblasHandle_t handle, hipblasFillMode_t uplo,                          \
...
#define CUSP_CUBLAS_SYR(T,V,name)                                                             \
  template<int dummy>                                                                         \
  hipblasStatus_t syr( hipblasHandle_t handle, hipblasFillMode_t uplo,                           \
...
#define CUSP_CUBLAS_TRMV(T,V,name)                                                            \
  template<int dummy>                                                                         \
  hipblasStatus_t trmv( hipblasHandle_t handle, hipblasFillMode_t uplo,                          \
...
#define CUSP_CUBLAS_TRSV(T,V,name)                                                            \
  template<int dummy>                                                                         \
  hipblasStatus_t trsv( hipblasHandle_t handle, hipblasFillMode_t uplo,                          \
                       hipblasOperation_t trans, hipblasDiagType_t diag,                        \
                       int n, const T* A, int lda, T* x, int incx)                            \
{                                                                                             \
...
#define CUSP_CUBLAS_GEMM(T,V,name)                                                            \
  template<int dummy>                                                                         \
  hipblasStatus_t gemm( hipblasHandle_t handle,                                                 \
...
#define CUSP_CUBLAS_SYMM(T,V,name)                                                            \
  template<int dummy>                                                                         \
  hipblasStatus_t symm( hipblasHandle_t handle,                                                 \
