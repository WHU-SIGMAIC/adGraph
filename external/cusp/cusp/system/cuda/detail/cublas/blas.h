         ...
         const Array& x)
{
    ...
    hipblasStatus_t stat = cublas::amax<0>(handle(exec), n, x_p, 1, result);
     ...
     const Array& x)
{
    ...
    hipblasStatus_t stat = cublas::asum<0>(handle(exec), n, x_p, 1, result);
    if(stat != HIPBLAS_STATUS_SUCCESS)
    {
          ...
          const ScalarType alpha)
{
    ...
    hipblasStatus_t stat = cublas::axpy<0>(handle(exec), n, ValueType(alpha), x_p, 1, y_p, 1);
    if(stat != HIPBLAS_STATUS_SUCCESS)
    {
                ...
                Array2& y)
{
    ...
    hipblasStatus_t stat = cublas::copy<0>(handle(exec), n, x_p, 1, y_p, 1);
    if(stat != HIPBLAS_STATUS_SUCCESS)
    {
    ...
    const Array2& y)
{
    ...
    hipblasStatus_t stat = cublas::dot<0>(handle(exec), n, x_p, 1, y_p, 1, result);
    if(stat != HIPBLAS_STATUS_SUCCESS)
    {
     ...
     const Array2& y)
{
    ...
    hipblasStatus_t stat = cublas::dotc<0>(handle(exec), n, x_p, 1, y_p, 1, &result);
    if(stat != HIPBLAS_STATUS_SUCCESS)
    {
     ...
     const Array& x)
{
    ...
    hipblasStatus_t stat = cublas::nrm2<0>(handle(exec), n, x_p, 1, result);
    if(stat != HIPBLAS_STATUS_SUCCESS)
    {
          ...
          const ScalarType alpha)
{
    ...
    hipblasStatus_t stat = cublas::scal<0>(handle(exec), n, alpha, x_p, 1);
    if(stat != HIPBLAS_STATUS_SUCCESS)
    {
          ...
          Array2& y)
{
    ...
    hipblasStatus_t stat = cublas::swap<0>(handle(exec), n, x_p, 1, y_p, 1);
    if(stat != HIPBLAS_STATUS_SUCCESS)
    {
          ...
          const ScalarType2 beta)
{
    ...
    hipblasOperation_t trans = LayoutType::order;
          ...
          const ScalarType2 beta)
{
    ...
    hipblasOperation_t transa = LayoutType1::order;
    hipblasOperation_t transb = LayoutType2::order;
    hipblasOperation_t transc = LayoutType3::order;
    ...
    if(transc == HIPBLAS_OP_T)
    {
        bool a_trans = Array2d1::orientation::transpose::value;
        bool b_trans = Array2d2::orientation::transpose::value;

        if(!b_trans)
            transa = (transa == HIPBLAS_OP_N) ? HIPBLAS_OP_T : HIPBLAS_OP_N;
        if(!a_trans)
            transb = (transb == HIPBLAS_OP_N) ? HIPBLAS_OP_T : HIPBLAS_OP_N;
          ...
          const ScalarType2 beta)
{
    ...
    hipblasFillMode_t  uplo  = HIPBLAS_FILL_MODE_UPPER;
    hipblasOperation_t trans = LayoutType1::order;
     ...
     const Array& x)
{
    ...
    hipblasStatus_t stat = cublas::asum(handle(exec), n, x_p, 1, result);
    if(stat != HIPBLAS_STATUS_SUCCESS)
    {
       ...
       const Array& x)
{
    ...
    hipblasStatus_t stat = cublas::amax(handle(exec), n, x_p, 1, index);
    if(stat != HIPBLAS_STATUS_SUCCESS)
    {
