...
struct cublas_transpose_op { const static hipblasOperation_t order = HIPBLAS_OP_T; };
struct cublas_normal_op    { const static hipblasOperation_t order = HIPBLAS_OP_N; };
