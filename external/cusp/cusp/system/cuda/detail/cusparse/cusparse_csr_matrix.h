...
namespace cusp
{
    namespace system
    {
        namespace cuda
        {
            ...
            class cusparse_csr_matrix : public cusp::csr_matrix_view<cusp::array1d_view<typename thrust::hip::vector<int>::iterator>,
                                                                     cusp::array1d_view<typename thrust::hip::vector<int>::iterator>,
                                                                     cusp::array1d_view<typename thrust::hip::vector<ValueType>::iterator>>
            {
            private:
                typedef typename thrust::hip::vector<int>::iterator IndexIterator;
                typedef typename thrust::hip::vector<ValueType>::iterator ValueIterator;
            ...
            public:
                    ...
                    : Parent(A)
                {
                    ...
                    {
                        throw cusp::runtime_exception("hipsparseCreateMatDescr failed");
                    }
                }
